...
config = {
    ...
    "weight_decay": 1.5e-6,
    "save_dir": "ckpts",
    "save_filename_with_suffix": "pretraining_multiscale_heatmap",
    "print_freq": 1,
    "save_freq": 5,  # TODO
    "eval_freq": 1,
    "resume": "",
...
# nohup python main_pretramain_pretraining_novelty_multiscale_heatmapsining_novelty.py > nohup_pretraining_novelty_multiscale_heatmaps.logs &
# nohup python main_far.py > nohup_far.logs &
# nohup python main_fer.py > nohup_fer.logs &

# nohup python main_pretraining_novelty_multiscale_heatmaps.py > nohup_pretraining_novelty_multiscale_heatmaps.logs && sleep 120 && nohup python main_pretraining_original.py > nohup_pretraining_original.logs &
